...
public class EscapeRoomHistoryRequest {
    ...
    @Max(value = 600, message = "클리어 시간은 180분 이하여야 합니다")
    ...
    @Min(value = 0, message = "난이도 평점은 0 이상이어야 합니다")
    @Max(value = 10, message = "난이도 평점은 10 이하여야 합니다")
    private Integer difficultyRating;
    
    @Min(value = 0, message = "재미 평점은 0 이상이어야 합니다")
    @Max(value = 10, message = "재미 평점은 10 이하여야 합니다")
    private Integer funRating;
    
    @Min(value = 0, message = "스토리 평점은 0 이상이어야 합니다")
    @Max(value = 10, message = "스토리 평점은 10 이하여야 합니다")
