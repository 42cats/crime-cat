...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, UUID> {
     ...
     * 특정 서버의 모든 메시지 조회
     */
    Page<ChatMessage> findByServerIdOrderByCreatedAtDesc(UUID serverId, Pageable pageable);

    /**
     * 특정 채널의 최근 N개 메시지 조회
     */
    @Query("SELECT cm FROM ChatMessage cm WHERE cm.channel.id = :channelId ORDER BY cm.createdAt DESC LIMIT :limit")
    List<ChatMessage> findRecentMessagesByChannelId(@Param("channelId") UUID channelId, @Param("limit") int limit);
    ...
    List<ChatMessage> findMessagesSinceByServerAndChannel(@Param("serverId") UUID serverId, @Param("channelId") UUID channelId, @Param("since") LocalDateTime since);
     ...
     */
    Page<ChatMessage> findByChannelIdAndUserIdOrderByCreatedAtDesc(UUID channelId, UUID userId, Pageable pageable);

    /**
     * 특정 서버에서 특정 사용자의 메시지 조회
     */
    Page<ChatMessage> findByServerIdAndUserIdOrderByCreatedAtDesc(UUID serverId, UUID userId, Pageable pageable);
    ...
    Page<ChatMessage> findByChannelIdAndContentContaining(@Param("channelId") UUID channelId, @Param("keyword") String keyword, Pageable pageable);

    /**
     * 특정 서버에서 키워드로 메시지 검색
     */
    @Query("SELECT cm FROM ChatMessage cm WHERE cm.server.id = :serverId AND cm.content LIKE %:keyword% ORDER BY cm.createdAt DESC")
    Page<ChatMessage> findByServerIdAndContentContaining(@Param("serverId") UUID serverId, @Param("keyword") String keyword, Pageable pageable);

    /**
     * 특정 채널의 메시지 타입별 조회
     */
    Page<ChatMessage> findByChannelIdAndMessageTypeOrderByCreatedAtDesc(UUID channelId, ChatMessage.MessageType messageType, Pageable pageable);
    ...
    Long countByChannelIdAndCreatedAtBetween(@Param("channelId") UUID channelId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
    ...
    Long countByServerIdAndCreatedAtBetween(@Param("serverId") UUID serverId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
    ...
    Page<ChatMessage> findByChannelIdAndCreatedAtBeforeOrderByCreatedAtDesc(@Param("channelId") UUID channelId, @Param("beforeTime") LocalDateTime beforeTime, Pageable pageable);
    ...
    List<ChatMessage> findByChannelIdAndCreatedAtAfterOrderByCreatedAtAsc(@Param("channelId") UUID channelId, @Param("afterTime") LocalDateTime afterTime);
    ...
    Page<ChatMessage> findByServerIdAndChannelIdOrderByCreatedAtDesc(@Param("serverId") UUID serverId, @Param("channelId") UUID channelId, Pageable pageable);
    ...
    List<ChatMessage> findRecentMessagesByServerAndChannel(@Param("serverId") UUID serverId, @Param("channelId") UUID channelId, @Param("limit") int limit);
    ...
    Page<ChatMessage> findByServerIdAndChannelIdAndContentContaining(@Param("serverId") UUID serverId, @Param("channelId") UUID channelId, @Param("keyword") String keyword, Pageable pageable);
    ...
    Page<ChatMessage> findByServerIdAndChannelIdAndUserIdOrderByCreatedAtDesc(@Param("serverId") UUID serverId, @Param("channelId") UUID channelId, @Param("userId") UUID userId, Pageable pageable);

    /**
     * 특정 서버-채널의 메시지 수 조회
     */
    @Query("SELECT COUNT(cm) FROM ChatMessage cm WHERE cm.server.id = :serverId AND cm.channel.id = :channelId")
    Long countByServerIdAndChannelId(@Param("serverId") UUID serverId, @Param("channelId") UUID channelId);
    ...
    Long countByServerIdAndChannelIdAndCreatedAtBetween(@Param("serverId") UUID serverId, @Param("channelId") UUID channelId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
    ...
    List<ChatMessage> findRecentActivityByServerId(@Param("serverId") UUID serverId, @Param("since") LocalDateTime since);
    ...
    ChatMessage findLastMessageByChannelId(@Param("channelId") UUID channelId);
    ...
    List<ChatMessage> findLastMessagesPerChannelByServerId(@Param("serverId") UUID serverId);
    ...
    Page<ChatMessage> findAllUserMessagesInServer(@Param("serverId") UUID serverId, @Param("userId") UUID userId, Pageable pageable);
    ...
    List<Object[]> findUserMessageCountsByServerIdSince(@Param("serverId") UUID serverId, @Param("since") LocalDateTime since);
    ...
    List<Object[]> findHourlyMessageCountsByChannelIdSince(@Param("channelId") UUID channelId, @Param("since") LocalDateTime since);
    ...
    void deleteByChannelIdAndCreatedAtBetween(@Param("channelId") UUID channelId, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
    ...
    void deleteAllUserMessagesInServer(@Param("serverId") UUID serverId, @Param("userId") UUID userId);
    ...
    void deleteAllByServerId(@Param("serverId") UUID serverId);
}