...
public interface ChannelMemberRepository extends JpaRepository<ChannelMember, UUID> {
    ...
    // 채널의 모든 활성 멤버 조회
    List<ChannelMember> findByChannelIdAndIsActiveTrue(UUID channelId);
    
    Page<ChannelMember> findByChannelIdAndIsActiveTrue(UUID channelId, Pageable pageable);

    // 특정 사용자가 특정 채널의 멤버인지 확인
    Optional<ChannelMember> findByChannelIdAndUserIdAndIsActiveTrue(UUID channelId, UUID userId);
    ...
    List<ChannelMember> findModeratorsByChannelId(@Param("channelId") UUID channelId);
    ...
    Optional<ChannelMember> findModeratorByChannelIdAndUserId(@Param("channelId") UUID channelId, @Param("userId") UUID userId);

    // 채널 멤버 수 조회
    @Query("SELECT COUNT(cm) FROM ChannelMember cm WHERE cm.channel.id = :channelId AND cm.isActive = true")
    long countByChannelIdAndIsActiveTrue(@Param("channelId") UUID channelId);
    ...
    List<ChannelMember> findRecentlyActiveMembersByChannelId(@Param("channelId") UUID channelId, @Param("since") LocalDateTime since);
    ...
    List<ChannelMember> findByChannelIdAndRole(@Param("channelId") UUID channelId, @Param("role") ChannelMember.ChannelRole role);
    ...
    boolean isUserModeratorOfChannel(@Param("channelId") UUID channelId, @Param("userId") UUID userId);
    ...
    boolean isUserMemberOfChannel(@Param("channelId") UUID channelId, @Param("userId") UUID userId);
    ...
    List<ChannelMember> findOnlineMembersByChannelId(@Param("channelId") UUID channelId, @Param("onlineThreshold") LocalDateTime onlineThreshold);
    ...
    List<ChannelMember> findByServerIdAndUserId(@Param("serverId") UUID serverId, @Param("userId") UUID userId);
    ...
    List<ChannelMember> findModeratorChannelsByServerIdAndUserId(@Param("serverId") UUID serverId, @Param("userId") UUID userId);
    ...
    // 채널 멤버 존재 여부 확인
    boolean existsByChannelIdAndUserIdAndIsActiveTrue(UUID channelId, UUID userId);
}