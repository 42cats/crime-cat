...
public class ThemeAdvertisementStatsService {
    ...
    public PlatformAdvertisementStats getPlatformStats() {
        ...
        return PlatformAdvertisementStats.builder()
                ...
                .totalExposures(totalExposures)
                .totalClicks(totalClicks)
                .topPerformingThemes(topPerformingThemes.subList(0, Math.min(10, topPerformingThemes.size())))
                .mostActiveThemes(mostActiveThemes.subList(0, Math.min(10, mostActiveThemes.size())))
                .averageCTR(avgCTR)
