                ...
                {filtersExpanded && (
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 border-t pt-4 animate-in fade-in duration-200">
                        <NumberRangeFilter
                            ...
                            onMinChange={(value) =>
                                onFilterChange("playerMin", value)
                            }
                            onMaxChange={(value) =>
                                onFilterChange("playerMax", value)
                            }
                        ...
                        <NumberRangeFilter
                            ...
                            onMinChange={(value) =>
                                onFilterChange("playtimeMin", value)
                            }
                            onMaxChange={(value) =>
                                onFilterChange("playtimeMax", value)
                            }
                        ...
                        <DifficultyFilter
                            ...
                            onMinChange={(value) =>
                                onFilterChange("difficultyMin", value)
                            }
                            onMaxChange={(value) =>
                                onFilterChange("difficultyMax", value)
                            }
                        />
                    </div>
                )}
