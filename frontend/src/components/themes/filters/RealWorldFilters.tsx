...
interface RealWorldFiltersProps {
...
const RealWorldFilters: React.FC<RealWorldFiltersProps> = ({
  filters,
  searchInput,
  sort,
  sortOptions,
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle className="text-lg">리얼월드 검색 및 필터</CardTitle>
      </CardHeader>
...
export default RealWorldFilters;