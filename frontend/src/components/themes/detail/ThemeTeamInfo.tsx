              ...
              {isLoadingTeam ? (
                ...
                <div className="mt-3">
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      className="relative"
                      onClick={() => teamData.members[0].userId ? onProfileClick(teamData.members[0].userId) : null}
                  ...
                  <div className="flex flex-wrap gap-4 mt-3">
                    {teamData.members.map((member) => (
                      <div key={member.id} className="flex flex-col items-center">
                        <button
                          className="relative"
                          onClick={() => member.userId ? onProfileClick(member.userId) : null}
                ...
                <div className="mt-3">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <button
                      ...
                      onClick={() => theme.team.members[0].userId ? onProfileClick(theme.team.members[0].userId) : null}
