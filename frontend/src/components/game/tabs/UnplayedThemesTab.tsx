        ...
        <div className="space-y-6">
            <Tabs value={activeGameType} onValueChange={handleGameTypeChange}>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            <SelectItem
                                                value={
                                                    ComparisonSortOption.RECOMMENDATION
                                                }
                                            >
                                                추천순
                                            </SelectItem>
                                            ...
                                            <SelectItem
                                                value={
                                                    ComparisonSortOption.VIEW_COUNT
                                                }
                                            >
                                                조회순
                                            </SelectItem>
                                            <SelectItem
                                                value={
                                                    ComparisonSortOption.PLAY_COUNT
                                                }
                                            >
                                                플레이순
                                            </SelectItem>
                    ...
                    {data && data.pageInfo.totalPages > 1 && (
                        <div className="flex justify-center gap-2">
                            <Button
                                variant="outline"
                                onClick={() =>
                                    handlePageChange((filter.page || 0) - 1)
                                }
                ...
                <TabsContent value="escaperoom" className="space-y-6 mt-6">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem
                                                value={
                                                    ComparisonSortOption.DIFFICULTY_ASC
                                                }
                                            >
                                                난이도 낮은순
                                            </SelectItem>
                                            <SelectItem
                                                value={
                                                    ComparisonSortOption.DIFFICULTY_DESC
                                                }
                                            >
                                                난이도 높은순
                                            </SelectItem>
                    ...
                    <div className="space-y-4">
                        {filteredThemes
                            .filter((t) => t.gameType === GameType.ESCAPE_ROOM)
                            .map((theme) => (
                                <Card
                                    key={theme.id}
                                    className="cursor-pointer hover:shadow-lg transition-shadow"
