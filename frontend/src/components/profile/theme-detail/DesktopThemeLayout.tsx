...
import { Heart, MessageSquare, Share2, FileText, ChevronsRight } from 'lucide-react';
      ...
      <div className={`flex flex-col bg-white transition-all duration-300 ease-in-out ${isImageCollapsed ? 'w-full' : 'w-2/5'}`}>
        ...
        {isImageCollapsed && (
          <button
            ...
            className="absolute top-12 left-4 p-2 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors z-10"
            title="이미지 펼치기"
          >
        ...
        >
          ...
          <TabsContent value="comments" className="overflow-y-auto h-full flex-grow">
