...
import { Trash2, Crown, ArrowUpCircle, ArrowDownCircle, User } from "lucide-react";
        ...
        >
          <AnimatePresence>
            {sortedMembers.map((member) => {
              ...
              const canDelete = isCurrentUserLeader || isCurrentUser;
                    ...
                    <div className="flex items-center gap-1">
                      {isCurrentUserLeader && !isCurrentUser && (
                        <Button
                          ...
                          aria-label={member.leader ? "리더 권한 해제" : "리더로 지정"}
                        >
                          {member.leader ? (
