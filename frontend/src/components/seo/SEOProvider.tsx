...
export const defaultSEO = {
    ...
    description:
        "미스터리 플레이스는 크라임씬 이라는 게임플레이를 위한 정보와 머더미스터리, 방탈출에 대한 정보 제공을 전문으로 합니다.",
    keywords:
        "크라임씬, 범죄 현장, 법의학, 포렌식, 범죄 심리, 수사 기법, 사건 분석, 크라임캣, CrimeCat, 머더미스터리, 방탈출, 보드게임",
    siteUrl: "https://mystery-place.com/",
    image: "content/images/default_image2.png",
