    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const requestData: EscapeRoomHistoryRequest = {
                ...
                ...(formData.escapeRoomLocationId && {
                    escapeRoomLocationId: formData.escapeRoomLocationId,
                }),
                ...(formData.clearTime && { clearTime: formData.clearTime }),
                ...(formData.hintCount !== undefined && {
                    hintCount: formData.hintCount,
                }),
                ...(formData.difficultyRating !== undefined && {
                    difficultyRating: formData.difficultyRating,
                }),
                ...(formData.funRating !== undefined && {
                    funRating: formData.funRating,
                }),
                ...(formData.storyRating !== undefined && {
            ...
            if (historyId) {
                await escapeRoomHistoryService.updateHistory(
                    historyId,
                    requestData
                );
                toast({
            ...
            <DialogContent className="sm:max-w-[525px] max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value) =>
                                setFormData({
                                    ...formData,
                                    successStatus: value as SuccessStatus,
                                })
                            }
                        >
                            <SelectTrigger>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setFormData({
                                    ...formData,
                                    hintCount: parseInt(e.target.value) || 0,
                                })
                            }
                        />
                    </div>
                    ...
                    <StarInput
                        ...
                        onChange={(value) =>
                            setFormData({ ...formData, funRating: value })
                        }
                        label="재미"
                    ...
                    <StarInput
                        ...
                        onChange={(value) =>
                            setFormData({ ...formData, storyRating: value })
                        }
                        label="스토리"
