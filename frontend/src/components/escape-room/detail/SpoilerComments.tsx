...
const SpoilerComments: React.FC<SpoilerCommentsProps> = ({
    ...
    const [hiddenComments, setHiddenComments] = useState<Set<string>>(
        new Set()
    );
    ...
    const fetchComments = async () => {
        try {
            ...
            setComments(
                response.content.filter((comment) => comment.isSpoiler)
            );
    ...
    return (
        <div className="space-y-6">
            ...
            <Alert>
                <AlertTriangle className="h-4 w-4" />
                <AlertDescription>
                    이 섹션에는 게임의 스포일러가 포함될 수 있습니다. 게임을
                    완전히 체험하기 전에는 주의해서 읽어주세요.
                </AlertDescription>
            </Alert>
            ...
            <div className="flex items-center gap-2">
                <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                        setShowSpoilers(checked as boolean)
                    }
                />
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-2">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                    setSpoilerAgreement(checked as boolean)
                                }
                            />
                            <label
                                htmlFor="spoiler-agreement"
                                className="text-sm"
                            >
