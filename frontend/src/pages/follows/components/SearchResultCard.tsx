        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Avatar className="h-12 w-12">
              ...
              />
              <AvatarFallback>
                {searchUser.nickname.substring(0, 2).toUpperCase()}
              </AvatarFallback>
            </Avatar>
            <div>
              <div className="font-medium">{searchUser.nickname}</div>
            ...
            <div>
              {searchUser.isFollowing ? (
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => unfollowMutation.mutate(searchUser.id)}
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => followMutation.mutate(searchUser.id)}
