...
const NoticeDetail: React.FC = () => {
    ...
    const {
        ...
        queryKey: ["notice", id],
        queryFn: () =>
            id ? noticesService.getNoticeById(id) : Promise.reject("No ID"),
        enabled: !!id,
    });
    ...
    const handleEdit = () =>
        navigate(`/notices/edit/${id}`, { state: { notice } });
                ...
                <div className="max-w-3xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between gap-4 sm:items-start">
                        <div className="flex-1 min-w-0">
                            ...
                            <h1 className="text-3xl font-bold break-words whitespace-pre-wrap leading-tight">
                                {notice.title}
                            </h1>
                        </div>
                        ...
                        <div className="flex flex-col items-end gap-2 whitespace-nowrap">
                            ...
                            <div className="text-sm text-muted-foreground text-right">
                                ...
                                <div>
                                    <strong>수정일</strong>{" "}
                                    <UTCToKST date={notice.updatedAt} />
                                </div>
                            </div>
                        </div>
                    </div>
