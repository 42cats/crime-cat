...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        const { head: user_id, option: character, otherOption: maxVote } = delimiterGeter(customId);
        ...
        commandUser.send(`${user.displayName || user.globalName} 님이 투표하셨습니다. ${votes.size} / ${Number(maxVote) + 1} 명투표!`);
        // 응답 메시지 구성
